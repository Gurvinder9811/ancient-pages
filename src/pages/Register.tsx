...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f4ecd8] flex items-center justify-center p-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-[#5c4a3a] font-serif italic">Join our community of scholars</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-[#d4c4a8] p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white/80 text-[#5c4a3a] font-serif">or register with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-[#01307b] font-medium">
                Full Name
              </Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-[#01307b] font-medium">
                Confirm Password
              </Label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-[#8b7355]" />
            ...
            <div className="flex items-start space-x-2">
              <Checkbox id="terms" className="border-[#d4c4a8] data-[state=checked]:bg-[#01307b] mt-1" />
              <Label htmlFor="terms" className="text-sm text-[#5c4a3a] cursor-pointer leading-relaxed">
                I agree to the{" "}
                <Link to="/terms" className="text-[#01307b] hover:underline">Terms of Service</Link>
                {" "}and{" "}
                <Link to="/privacy" className="text-[#01307b] hover:underline">Privacy Policy</Link>
              </Label>
            </div>
          ...
          <p className="mt-6 text-center text-[#5c4a3a]">
            ...
            <Link to="/login" className="text-[#01307b] hover:underline font-semibold">
              Sign in
            </Link>
          </p>
        </div>
